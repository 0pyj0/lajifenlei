...
parser.add_argument('--train-batch', default=5, type=int, metavar='N',
                    help='train batchsize (default: 56)')
parser.add_argument('--test-batch', default=2, type=int, metavar='N',
                    help='test batchsize (default: 20)')
...
# Architecture
parser.add_argument('--arch', '-a', metavar='ARCH', default='resnext101_32x8d_wsl',
                    choices=model_names,
